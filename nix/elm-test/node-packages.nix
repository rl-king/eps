...
in
{
  "elm-test-https://github.com/rtfeldman/node-test-runner/tarball/933064c2ce4043fe90ecbeb7f28737e427f3e781" = nodeEnv.buildNodePackage {
    name = "elm-test";
    packageName = "elm-test";
    version = "0.19.0-beta9";
    src = fetchurl {
      name = "elm-test-0.19.0-beta9.tar.gz";
      url = https://codeload.github.com/rtfeldman/node-test-runner/legacy.tar.gz/933064c2ce4043fe90ecbeb7f28737e427f3e781;
      sha256 = "f6bce0f1bc46cff2c9d52c2f0f8f18768b8c31a0eae342f6f3f4ae5fa5d9c27b";
    };
    dependencies = [
      sources."ajv-5.5.2"
